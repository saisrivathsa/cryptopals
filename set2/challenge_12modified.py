'''
Only difference between the previous 12th program and this one is that instance of "byte_at_a_time_oracle" is passed around to other functions
so that it can be used in the coming challenges
'''
from challenge_11 import random_key_generator, AES, randint, pad
...
def next_chr(oracle, block_size, known): # finding the next characer of the text by checking the original with all possible characters
